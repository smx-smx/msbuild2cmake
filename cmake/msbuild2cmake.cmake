...
# `MSBUILD_PLATFORM`, which is expected to be passed from $(Platform)
...
#	endif()
	...
	message(STATUS "Building in: ${proj_BUILD_DIR}")
...
function(process_project name path)
	set(BUILD_DIR ${path}/build/${MSBUILD_PLATFORM}/${CMAKE_BUILD_TYPE})
...
message("=> Platform  : ${MSBUILD_PLATFORM}")
message("=> Target    : ${TARGET}")
message("")

# AnyCPU is not a valid native platform, so we filter it out here
set(MSBUILD_ACTUAL_PLATFORM "")
if(NOT MSBUILD_PLATFORM STREQUAL "AnyCPU"
AND NOT MSBUILD_PLATFORM STREQUAL "Any CPU"
)
	set(MSBUILD_ACTUAL_PLATFORM ${MSBUILD_PLATFORM})
endif()
